 ...
 * 
 * This library is for controlling a continuas 4 wire 360 deg. servo motor which provides PWM feedback.
 ...
 * 
 * @warning This library is only compatible with the Arduino framwork version 1.0 and later.
 * cxc
...
namespace feedback_servo{
    ...
    #define MIN_DUTY_CYCLE  2.9 // Minimum duty cycle for the PWM feedback.
    #define MAX_DUTY_CYCLE  97.1 // Maximum duty cycle for the PWM feedback.

    #define FEEDBACK_SIGNAL_FREQUENCY_HZ   910 // Frequency of the PWM feedback in Hz.
    #define T_CYCLE (1.0 / FEEDBACK_SIGNAL_FREQUENCY_HZ) // The cycle time, a.k.a. the perod of the PWM signal in seconds.
    ...
    */
    class Feedback360Servo{
        ...
        */
        ...
        /*! 
        * Turn the servo motor from the currentn angular position to the desighred angular position.
        * Will take the shortest path to the desired angle.
        * Ex: If the servo is at an angle of 250 and needs to turn to and angle of 5 deg, it will turn clockwise to the angle, passing 360 deg, rather than turn counterclockwise.
        * Interupts are disabled while parts of the function are running. 
        * Uses a PID controler to acheive higher position accuracy.
        * @param angle The angle to traval to.
        * @return True if motor turns to desired angle, False if it can not or invalid direction passed.
        */
        bool turnToShortPID(double angle);
        #endif
    };
