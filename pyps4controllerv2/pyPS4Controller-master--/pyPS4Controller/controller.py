...
class Actions:
   ...
   # def on_up_down_arrow_release(self):
    ...
    def on_L3_y_at_rest(self):
        #stops left motor tank movement
        print("Stop")
    ...
    #def on_playstation_button_press(self):
        #auto connects to Pi (must be config one time via ssh@IP/MAC address)
...
class Controller(Actions):
    ...
    def __init__(
            self, interface, connecting_using_ds4drv=False,
