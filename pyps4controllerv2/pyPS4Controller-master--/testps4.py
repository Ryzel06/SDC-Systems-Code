...
baud_rate = 2400                                                      # Assign the baudrate to a value
string1 = "Hello!"
...
axes_to_check = [1,4]                                   #-# List the axes to check. Here, I want to check axis #1 and #3.
...
#LEFT JOYSTICK Y AXIS
        if current_axis == 1 and latest_value < 0.00: ser.write(string1) #and
...
# RIGHT JOYSTICK Y-AXIS
        if current_axis == 4 and latest_value < 0.00: print ' Right Moving Forward'
        elif current_axis == 4 and latest_value > 0.00: print 'Right Moving Backward'
        elif current_axis == 4 and latest_value == 0.00: print 'Right Rest'

        #ser.write('A'.encode())
        #if current_axis == 1 and latest_value < 0.00: print 'Left Moving Forward'
        #Serial.read("A")
        #elif current_axis == 1 and latest_value > 0.00: print 'Left Moving Backward'
       # arduino.write('2')
        #elif current_axis == 1 and latest_value == 0.00: print 'Left Rest'
       # arduino.write('0')
# RIGHT JOYSTICK
        #elif current_axis == 4 and latest_value < 0.00: print ' Right Moving Forward'
       # arduino.write('4')
        #elif current_axis == 4 and latest_value > 0.00: print 'Right Moving Backward'
       # arduino.write('5')
        #elif current_axis == 4 and latest_value == 0.00: print 'Right Rest'
